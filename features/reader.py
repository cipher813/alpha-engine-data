"""
features/reader.py — Read feature snapshots from S3.

Provides functions for reading single-date snapshots and date ranges.
Used by predictor, executor, research, and backtester as S3-contract consumers.

Self-contained copy from alpha-engine-predictor/feature_store/reader.py.
"""
