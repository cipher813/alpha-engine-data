...
if __name__ == "__main__":
    ...
    if trading:
        ...
        # Always exit 0 — Step Function checks stdout for TRADING_DAY marker,
        # not exit code. Non-zero exit = SSM "Failed" status which is ambiguous
        # (could be holiday OR script crash).
        sys.exit(0)
    else:
